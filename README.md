...
Google Apps Script to automate work + personal calendars. Replacement of some Clockwise features:
...
4. Tweak the various parameters (length of lunch, start/end time, look-ahead days, etc)
